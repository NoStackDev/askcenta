    ...
    >
      ...
      <div className="font-roboto text-sm leading-[22px] text-black mt-8 text-justify">
        ...
        <div className="mt-4 md:mt-8">
          <h2 className="font-medium">Information Collection and Use</h2>

          <div>
            <p>1.1. Types of Data Collected</p>
            <div className="mt-4 md:mt-8">
              <p>1.1.1 Personal Data</p>
              <p className="mt-4 md:mt-8">
                We use your data to provide and improve the Platform. By using
                the Platform, you agree to the collection and use of information
                in accordance with this policy.
              </p>
            </div>
            <div>
              <p className="mt-4 md:mt-8">1.1.2. Usage Data</p>
              <p className="mt-4 md:mt-8">
                We use your data to provide and improve the Platform. By using
                the Platform, you agree to the collection and use of information
                in accordance with this policy.
            ...
            <div>
              <p className="mt-4 md:mt-8">1.1.3. Tracking & Cookies Data</p>
              <p className="mt-4 md:mt-8">
          ...
          <div className="mt-4 md:mt-8">
            ...
            <div className="mt-4 md:mt-8">
              <p>To provide and maintain our Platform</p>
              ...
              <p>To monitor the usage of our Platform</p>
              <p>To detect, prevent, and address technical issues</p>
            </div>
          </div>

          <div className="mt-4 md:mt-8">
            <p>1.3. Data Retention</p>
            <p className="mt-4 md:mt-8">
        ...
        <div className="mt-4 md:mt-8">
          <h2 className="font-medium">Disclosure of Data</h2>

          <div>
            <p>2.1. Legal Requirements</p>
            <div className="mt-4 md:mt-8">
              <p>
        ...
        <div className="mt-4 md:mt-8">
          <h2 className="font-medium">Security of Data</h2>
          <p className="mt-4 md:mt-8">
            The security of your data is important to us. However, please
        ...
        <div className="mt-4 md:mt-8">
          <h2 className="font-medium">Your Data Protection Rights</h2>
          <p className="mt-4 md:mt-8">
            You have certain data protection rights. If you wish to be informed
            about what Personal Data we hold about you and if you want it to be
            removed from our systems, please contact us using the contact
            details provided below.
          </p>
        </div>

        <div className="mt-4 md:mt-8">
          <h2 className="font-medium">Terms Of Usage</h2>
          <p className="mt-4 md:mt-8">
            These Terms of Use (the “Terms”) constitute a binding and
            enforceable legal contract between Askcenta, its affiliated
            companies (together, the “Administrator”, “we”, “us”) and you.
            Please read these Terms carefully.Your access and use of the
            Askcenta website and mobile applications, as well as any service,
            content, and data available via them (together, the “Service” or the
            “Platform”) are governed by these Terms.
          </p>
          <p>
            If you do not agree with any part of these Terms, or if you are not
            eligible or authorized to be bound by the Terms, then do not access
            or use the Service.
          </p>
        </div>

        <div className="mt-4 md:mt-8 uppercase">
          ...
          <ol type="1" className="list-decimal mt-4 md:mt-8 pl-4">
            <li>
              ...
              LIMITATION ANY GUARANTEES REGARDING CONDITION, QUALITY, LIFE
            ...
            <li>
              ...
              WILL ACTUALLY COMPLETE A TRANSACTION. ADMINISTRATOR MAKES NO
        ...
        <div className="mt-4 md:mt-8">
          ...
          <ol type="1" className="list-decimal mt-4 md:mt-8 pl-4">
            ...
            <li>
              ...
              and the Administrator itself is not a party to such transactions.
              The Administrator provides users with an opportunity to
              communicate.
            </li>
            <li>
            ...
            <li>
              ...
              announcements posted by users without any notice in the event of:
              (i) receiving of mandatory judgments of competent public
              authorities; (ii) claim of a holder of intellectual property
              rights to terminate infringement of his/her rights by a user on
              the Platform; (iii) infringements of rights or legal interests of
              other users, legal entities, or individuals upon their reasonable
              request; (iv) detecting that announcement posted by user on the
              Platform breaches these Terms or any applicable law, regulation,
              rule or standard.
            </li>
            <li>
              The Administrator is authorized to delete or block announcements
              of users regardless of providing a user with the relevant
              substantiation.
            </li>
            <li>
            ...
            <li>
              ...
              or her User Content (as defined below). Because we do not control
              the User Content, you acknowledge and agree that we are not
              responsible for any User Content and we make no guarantees
              ...
              between you and such users. You agree that the Administrator will
            ...
            <li>
              ...
              online properties to which the Third Party Ads lead, may not be
        ...
        <div className="mt-4 md:mt-8">
          <h2 className="font-medium">INDEMNITY</h2>
          <p className="mt-4 md:mt-8">
            ...
            your violation of any applicable law, industry-standard, regulation,
            guideline, rule; (v) any transaction entered into by you via the
            Platform or your violation of terms of such transaction. The
            Administrator reserves the right, at your expense, to assume the
        ...
        <div className="mt-4 md:mt-8 uppercase">
          ...
          <p className="mt-4 md:mt-8">
            ...
            THESE TERMS OR YOUR USE OF, OR INABILITY TO USE, THE SERVICE, OR
            THIRD-PARTY ADS, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF
            SUCH DAMAGES. ACCESS TO, AND USE OF, THE SERVICE, AND THIRD-PARTY
            ADS ARE AT YOUR OWN DISCRETION AND RISK, AND YOU WILL BE SOLELY
