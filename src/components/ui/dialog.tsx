  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "data-[state=open]:animate-contentShow md:data-[state=open]:animate-contentShowMd w-screen md:w-1/2 md:max-w-[500px] h-screen md:h-4/5 md:max-h-[800px] fixed top-0 md:top-[50%] md:left-[50%] md:translate-x-[-50%] md:translate-y-[-50%] bg-white focus:outline-none z-40",
          className
        )}
        ref={ref}
        {...props}
