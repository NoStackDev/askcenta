  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "data-[state=open]:animate-contentShow md:data-[state=open]:animate-contentShowMd w-screen md:w-1/2 h-screen md:h-1/2 fixed top-0 md:top-[50%] md:left-[50%] md:translate-x-[-50%] md:translate-y-[-50%] bg-white md:shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none z-40",
          className
        )}
        ref={ref}
        {...props}
